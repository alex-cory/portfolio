...
export default class Bio extends Component {
	render() {
		return (
            ...
            <p className={s.wider}>"<text className={s.mphszGreen}>Sometimes, ordinary people do extraordinary things, simply because they believe they can and refuse to give up.</text>" -Alex Cory</p>
	        </Col>
